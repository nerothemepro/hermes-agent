...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("social-auto-post", "HerSocial live Facebook text-post shortcut", "Tools & Skills",
               gateway_only=True, gateway_config_gate="quick_commands.social-auto-post",
               args_hint="caption: <text>"),
    CommandDef("social-auto-dry-run", "HerSocial Facebook text-post preview shortcut", "Tools & Skills",
               gateway_only=True, gateway_config_gate="quick_commands.social-auto-dry-run",
               args_hint="caption: <text>"),
    CommandDef("social-trend-preview", "HerSocial trend-to-post preview shortcut", "Tools & Skills",
               gateway_only=True, gateway_config_gate="quick_commands.social-trend-preview",
               args_hint="topic: <topic> summary: <summary>"),
    CommandDef("social-image-preview", "HerSocial image post preview shortcut", "Tools & Skills",
               gateway_only=True, gateway_config_gate="quick_commands.social-image-preview",
               args_hint="topic: <topic> summary: <summary> media_path: <path>"),
    CommandDef("social-video-preview", "HerSocial video post preview shortcut", "Tools & Skills",
               gateway_only=True, gateway_config_gate="quick_commands.social-video-preview",
               args_hint="topic: <topic> summary: <summary> media_path: <path>"),
    ...
    CommandDef("wiki-ingest", "HerWiki deterministic SDTK-WIKI ingest shortcut", "Tools & Skills",
               cli_only=True, gateway_only=True, gateway_config_gate="quick_commands.wiki-ingest"),
    CommandDef("wiki-compile", "HerWiki deterministic SDTK-WIKI compile shortcut", "Tools & Skills",
               cli_only=True, gateway_only=True, gateway_config_gate="quick_commands.wiki-compile"),
    CommandDef("wiki-lint", "HerWiki deterministic SDTK-WIKI lint shortcut", "Tools & Skills",
               cli_only=True, gateway_only=True, gateway_config_gate="quick_commands.wiki-lint"),
    CommandDef("wiki-maintain", "HerWiki deterministic SDTK-WIKI maintain shortcut", "Tools & Skills",
               cli_only=True, gateway_only=True, gateway_config_gate="quick_commands.wiki-maintain"),
    CommandDef("wiki-discover", "HerWiki deterministic SDTK-WIKI discover shortcut", "Tools & Skills",
               cli_only=True, gateway_only=True, gateway_config_gate="quick_commands.wiki-discover"),
    CommandDef("wiki-search", "HerWiki deterministic SDTK-WIKI search shortcut", "Tools & Skills",
               cli_only=True, gateway_only=True, gateway_config_gate="quick_commands.wiki-search",
               args_hint="<query>"),
    ...
    CommandDef("health", "HerOrches per-profile health shortcut", "Tools & Skills",
               gateway_only=True, gateway_config_gate="quick_commands.health",
               args_hint="[profile]"),
    CommandDef("diag", "HerOrches diagnosis shortcut", "Tools & Skills",
               gateway_only=True, gateway_config_gate="quick_commands.diag",
               args_hint="[profile|all]"),
    CommandDef("tail", "HerOrches recent gateway log shortcut", "Tools & Skills",
               gateway_only=True, gateway_config_gate="quick_commands.tail",
               args_hint="<profile> [lines]"),
    CommandDef("recover-all", "HerOrches fleet recovery shortcut", "Tools & Skills",
               gateway_only=True, gateway_config_gate="quick_commands.recover-all"),
    CommandDef("recover", "HerOrches per-profile recovery shortcut", "Tools & Skills",
               gateway_only=True, gateway_config_gate="quick_commands.recover",
               args_hint="<profile>"),
    CommandDef("models", "HerOrches LM Studio model visibility shortcut", "Tools & Skills",
               gateway_only=True, gateway_config_gate="quick_commands.models"),
    CommandDef("deps", "HerOrches dependency health shortcut", "Tools & Skills",
               gateway_only=True, gateway_config_gate="quick_commands.deps"),
    CommandDef("incidents", "HerOrches incident summary shortcut", "Tools & Skills",
               gateway_only=True, gateway_config_gate="quick_commands.incidents"),
